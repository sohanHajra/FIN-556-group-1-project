...
#ifndef _STRATEGY_STUDIO_VENUE_ARB_SUPER_AGGRESSIVE_STRATEGY_H_
#define _STRATEGY_STUDIO_VENUE_ARB_SUPER_AGGRESSIVE_STRATEGY_H_
...
class venue_arb_super_aggressive : public Strategy {
public:
    venue_arb_super_aggressive(StrategyID strategyID,
             const std::string& strategyName,
             const std::string& groupName);

    ~venue_arb_super_aggressive();
...
extern "C" {
    ...
    _STRATEGY_EXPORTS const char* GetType() {
        return "venue_arb_super_aggressive";
    }
    ...
    _STRATEGY_EXPORTS IStrategy* CreateStrategy(const char* strategyType,
        ...
        if (strcmp(strategyType, GetType()) == 0)
            return *(new venue_arb_super_aggressive(strategyID, strategyName, groupName));
        return nullptr;
    }
